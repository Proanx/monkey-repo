            ...
            for (const node of mutationDetail.addedNodes) {
                ...
                switch (node.classList[1]) {
                    ...
                    case "danmaku-item":
                        ...
                        if (node.dataset.danmaku.match(/^\[.+\]$/) && (tempVar = node.querySelectorAll(".emoticon"), tempVar && tempVar.length > 0)) {
                        ...
                        if (tempVar = node.querySelector(".wealth-medal-ctnr")) {
                            tempVar && tempVar.classList.remove("v-middle");
                        }
                        break;
                    // 舰长开通
                    case "system-msg":

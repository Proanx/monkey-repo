...
; (async function () {
    ...
    //颜文字列表 会自动按长度排序
    var kaomojiList = ["( •᷄⌓•᷅ )", "ᕕ( ´Д` )ᕗ", "(ꐦÒ‸Ó)", "⚈△⚈", "꒪꒫꒪)", "(›´ω`‹ )", "_(´□`」 ∠)_", "_(꒪□꒪」∠)_", "┭┮﹏┭┮", "Σ>―(〃°ω°〃)♡→", "ヽ(ﾟ∀ﾟ)♡(ﾟ∀ﾟ)ﾉ", "ヽ( ´Д｀)ﾉ", "━━━∑(ﾟ□ﾟ*|||━", "(,,´•ω•)ノ(´っω•｀。)", "ヽ(･ω･｡)ﾉ", "_(┐「ε:)_", "⊙_⊙", "(・_・;)", "（ '▿ ' ）", "●█▀█▄", "▄█▀█●", "(｡･ω･｡)", "⊙ω⊙", "( ˘•ω•˘ )", "(〃∀〃)", "(´･_･`)", "ᶘ ᵒᴥᵒᶅ", "(っ ‸ -｡)", "乛◡乛", "(っ °Д °;)っ", "⁄(⁄ ⁄•⁄ω⁄•⁄ ⁄)⁄", "o(o･`з･´o)ﾉ!!!", "(=^･ｪ･^=)", "｜д•´)!!", " ( ´･ᴗ･` ) ", "(●ˇ∀ˇ●)", "(◍ ´꒳` ◍)", "ヾ(●´∇｀●)ﾉ", "ヾ(❀╹◡╹)ﾉ~", "( ✿＞◡❛)", "(°ロ°)", "( ・◇・)?", "վ'ᴗ' ի", "Ծ‸Ծ", "(｡•ˇ‸ˇ•｡)", "╮(￣▽￣)╭", "( ´_ゝ`)", "(´-ι_-｀)", "(〜￣△￣)〜", "～(￣▽￣～)", "ヾ(•ω•`)o", "( ๑╹ ꇴ╹) ｸﾞ好耶", "ಥ_ಥ", "ಠ_ಠ", "(´ฅω•ฅ`)", "(´・ω・`)", "_(:3」∠)_", "Σ( ° △ °|||)", "(ﾟДﾟ≡ﾟдﾟ)!?", "(＃°Д°)", "Σ( ￣□￣||)", "(´；ω；`)", "(▔□▔)/", "(⊙x⊙;)", "(っ╥╯﹏╰╥c)", "(●￣(ｴ)￣●)", "(´∀｀)♡", "(≖_≖ )", "（￣へ￣）", "[┐'_'┌]", "ヽ(`Д´)ﾉ", "(╯°口°)╯(┴—┴"];

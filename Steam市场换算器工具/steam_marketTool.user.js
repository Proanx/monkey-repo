        ...
        methods: {
            ...
            calculateExchangeValue(self) {
                ...
                if (!+this.exchangeValue[self]) {
                    ...
                    this.inputList["cost"].value = this.exchangeValue[target] = this.exchangeValue[self];
                    ...
                    this.inputList["cost"].value = this.exchangeValue[target] = this.$options.methods.toFixed(foreign);
                    this.updateValue("cost");
                }
            },
            toFixed(value) {

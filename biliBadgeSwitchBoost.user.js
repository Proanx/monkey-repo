...
(function init() {
    ...
    // 旧的粉丝牌样式
    GM_addStyle(".old-style.fans-medal-item{border:1px solid #fff;border-radius:2px;padding:0;height:16px}.old-style .fans-medal-label{height:13px;border-radius:0;padding:0 3px 1px}.old-style .fans-medal-label .fans-medal-content{transform:none}.old-style .fans-medal-level{width:17px;height:14px;border-radius:0}");
        ...
        methods: {
            ...
            refreshMedal() {
                ...
                if (this.currentlyWearing.medal.medal_id != 0) {
                    selector.innerHTML = `
                        <div class="v-middle fans-medal-item old-style medal-item-margin"
                                ...
                                <div class="medal-item-content">
                                    ...
                                    <div class="dp-i-block v-bottom w-100 p-relative">
                                        <div class="medal-content-head">
                                            <div class="fans-medal-item old-style f-right"

...
(function init() {
    ...
    .medal-item .bili-avatar .bili-avatar-img {
        border: 1px solid var(--line_light);
    }

    .medal-item .bili-avatar-img-radius {
        border-radius: 50%;
    }

    .medal-item .bili-avatar-img {
        border: none;
        display: block;
        -o-object-fit: cover;
        object-fit: cover;
    ...
    .medal-item .bili-avatar-right-icon {
        width: 27.5%;
        height: 27.5%;
        position: absolute;
        z-index: 2;
